...
- To support course 20774 Perform Cloud Data Science with Azure Machine Learning, we will need to make frequent updates to the course content to keep it current with the Azure services used in the course. We are publishing the lab instructions and lab files on GitHub to allow for open contributions between the course authors and MCTs to keep the content current with changes in the Azure platform.
...
- It is recommended that for every delivery of 20774, trainers check GitHub for any changes that may have been made to support the latest Azure services, and get the latest files for their delivery.
...
> **MCTs:** Refer to the '20774AGitHubUserGuideforMCTs.pdf' file on the Download Center for detailed instructions for using GitHub. This document is also available on the GitHub repo as [20774A GitHub UserGuide for MCTs](20774AGitHubUserGuideforMCTs.md).  
