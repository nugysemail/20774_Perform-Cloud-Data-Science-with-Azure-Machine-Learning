...
12. On the **Query editor (preview)** blade, enter the following details, and then click **OK**:
    ...
    -  **Login**: dbadmin
    -  **Password**: Pa55w.rd
13. In line 1, type the following commands, and then click **Run**:
...
15. In line 1, type the following commands, and then click **Run**:
...
21. In the **Upload a new dataset** dialog box, click **Choose File**.
