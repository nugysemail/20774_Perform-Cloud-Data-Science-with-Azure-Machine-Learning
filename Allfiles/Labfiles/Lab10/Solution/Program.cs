...
namespace CallBatchExecutionService
{
    ...
    class Program
    {
        ...
        {
            const string OutputFileLocation = "E:\\BESresults.csv"; // Replace this with the location you would like to use for your output file, and valid file extension (usually .csv for scoring results, or .ilearner for trained models)
